...
export const companionPool = Object.freeze([
    { id: 'bun', label: 'Kiri', music: 'piano', bodyColor: '#f3ecff', accentColor: '#d9c9ff', pupilColor: '#2a2350', ears: 'round', scale: 0.92 },
    { id: 'ink', label: 'Miki', music: 'drums', bodyColor: '#2a2350', accentColor: '#3a2f63', pupilColor: '#fff8ff', ears: 'cat', scale: 0.86 },
    { id: 'sky', label: 'Tori', music: 'winds', bodyColor: '#6fb7ff', accentColor: '#a9d6ff', pupilColor: '#0d0a2a', ears: 'none', scale: 0.8 },
