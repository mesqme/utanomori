...
import {
    ...
    DEFAULT_JOYSTICK_PARAMETERS,
    DEFAULT_MOBILE_CAMERA_PARAMETERS,
    DEFAULT_MOBILE_STONE_PARAMETERS,
    DEFAULT_MOBILE_UI_PARAMETERS,
    DEFAULT_COLOR_PRESET_PARAMETERS,
    DEFAULT_THEME_TRANSITION_PARAMETERS,
...
const createStore = () =>
    create(
        subscribeWithSelector((set, get) => ({
            ...
            joystickParameters: { ...DEFAULT_JOYSTICK_PARAMETERS },
            mobileCameraParameters: { ...DEFAULT_MOBILE_CAMERA_PARAMETERS },
            mobileStoneParameters: { ...DEFAULT_MOBILE_STONE_PARAMETERS },
            mobileUiParameters: { ...DEFAULT_MOBILE_UI_PARAMETERS },
            colorPresetParameters: { ...DEFAULT_COLOR_PRESET_PARAMETERS },
            themeTransitionParameters: { ...DEFAULT_THEME_TRANSITION_PARAMETERS },
...
if (import.meta?.hot) {
    ...
    useStore.setState({
        ...
        joystickParameters: { ...DEFAULT_JOYSTICK_PARAMETERS, ...state.joystickParameters },
        mobileCameraParameters: { ...DEFAULT_MOBILE_CAMERA_PARAMETERS, ...state.mobileCameraParameters },
        mobileStoneParameters: { ...DEFAULT_MOBILE_STONE_PARAMETERS, ...state.mobileStoneParameters },
        mobileUiParameters: { ...DEFAULT_MOBILE_UI_PARAMETERS, ...state.mobileUiParameters },
        colorPresetParameters: { ...DEFAULT_COLOR_PRESET_PARAMETERS, ...state.colorPresetParameters },
        themeTransitionParameters: { ...DEFAULT_THEME_TRANSITION_PARAMETERS, ...state.themeTransitionParameters },
